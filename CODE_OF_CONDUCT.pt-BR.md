[English](CODE_OF_CONDUCT.md) | [Português Brasileiro](CODE_OF_CONDUCT.pt-BR.md)
...
## Nosso Compromisso
- Comprometemo-nos a tornar a participação na comunidade livre de assédio para todas as pessoas
- Este compromisso cobre idade, corpo, deficiência, etnia, características sexuais, identidade e expressão de gênero, experiência, educação, status socioeconômico, nacionalidade, aparência, raça, religião e identidade e orientação sexual

## Nossos Padrões
- Demonstre empatia e gentileza com outras pessoas
- Respeite opiniões, pontos de vista e experiências diferentes
- Dê e receba feedback construtivo com elegância
- Aceite responsabilidade e peça desculpas a quem for afetado por erros
- Foque no que é melhor para a comunidade como um todo
- Comportamento inaceitável inclui linguagem ou imagens sexualizadas
- Comportamento inaceitável inclui trolling, insultos e ataques pessoais ou políticos
- Comportamento inaceitável inclui assédio público ou privado
...
- Banimento permanente: banimento permanente por padrão de violação ou má conduta grave
