...
pub(super) fn base_key_entries() -> Vec<Value> {
    let entries = json!([
            ...
            {"key": "screen", "default": null, "description": "Default screen WxH for device metrics (absent = mirror the viewport)"},
            ...
            {"key": "user_data_dir", "default": null, "description": "Persistent Chrome profile dir; unset keeps residual-zero"},
