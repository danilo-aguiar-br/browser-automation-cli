...
pub use resolve::{
    ...
    resolve_cdp_connection_probe_timeout_secs, resolve_chrome_legacy_oxide_launch,
    ...
    resolve_gif_max_frames, resolve_http_connect_timeout_secs, resolve_http_ssrf_mode,
    ...
    resolve_redis_allow_remote, resolve_redis_connect_timeout_secs, resolve_robots_loopback_exempt,
    resolve_screencast_jpeg_quality, resolve_svg_max_bytes, resolve_svg_max_depth,
    resolve_svg_max_entities, resolve_video_default_audio_bitrate, resolve_video_default_container,
...
pub use resolve_scrape::{
    ...
    resolve_scrape_min_delay_ms, resolve_scrape_sitemap_max_bytes, resolve_scrape_summary_chars,
    resolve_scrape_use_sitemap,
};
