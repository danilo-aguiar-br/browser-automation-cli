...
//! `BROWSER_AUTOMATION_CLI_COLOR=1`. Setting `NO_COLOR` to any value disables
...
/// `BROWSER_AUTOMATION_CLI_COLOR` (truthy enables) > default (off).
pub fn is_enabled() -> bool {
    ...
    *COLORS_ENABLED.get_or_init(|| {
        ...
        env_is_truthy("BROWSER_AUTOMATION_CLI_COLOR").unwrap_or(false)
    })
}
